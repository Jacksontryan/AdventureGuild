...
public class Population {
    ...
    public void age(){
        ...
        for(Person person: people){
            ...
            if(!person.isMarried()){
                ...
                if(potentialCandidate.getAge() >= race.getReproductionAge() && !potentialCandidate.isMarried() && ageCompatible && !deadPeople.contains(potentialCandidate) && !deadPeople.contains(person)){
    ...
    public static void main(String[] args) throws FileNotFoundException, InterruptedException {
        ...
        File humanFile = new File("src\\main\\java\\project\\People\\PeopleTesting\\PopulationFiles\\HumanPopulation.txt");
        File dwarfFile = new File("src\\main\\java\\project\\People\\PeopleTesting\\PopulationFiles\\DwarfPopulation.txt");
        File elvesFile = new File("src\\main\\java\\project\\People\\PeopleTesting\\PopulationFiles\\ElfPopulation.txt");
        File orcsFile = new File("src\\main\\java\\project\\People\\PeopleTesting\\PopulationFiles\\OrcPopulation.txt");
